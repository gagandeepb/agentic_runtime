defmodule AgenticRuntime.Agents.AgentPersistence do
  ...
  via `AgenticRuntime.Conversations.save_agent_state/2`.
  """
  ...
  def persist_state(agent_id, state_data, context) do
    ...
    case AgenticRuntime.Conversations.save_agent_state(conversation_id, state_data) do
      {:ok, _} ->
  ...
  def load_state(agent_id) do
    conversation_id = extract_conversation_id(agent_id)
    AgenticRuntime.Conversations.load_agent_state(conversation_id)
  end
